...
export default function Header({ onClear }: HeaderProps) {
  return (
    <header className="h-16 bg-slate-800 border-b border-slate-700 flex items-center justify-between px-6 text-white shadow-md z-10">
      ...
      <div className="flex gap-3">
        <button 
          onClick={onClear}
          className="bg-slate-700 hover:bg-slate-600 px-4 py-2 rounded-lg text-sm font-medium transition-all"
        >
          Temizle
        </button>
